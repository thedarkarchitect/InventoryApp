...
class ItemEntryViewModel(private val itemsRepository: ItemsRepository) : ViewModel() {
    ...
    private fun validateInput(uiState: ItemDetails = itemUiState.itemDetails): Boolean {
        //this function checks if the name, price and quantity are empty so the function verifies the user input before adding or updaing the entity in the database
        return with(uiState) {
...
data class ItemDetails(//represents a single item
    val id: Int = 0,
    val name: String = "",
    val price: String = "",
    val quantity: String = "",
